...
import { User, Heart, Calendar, Shield, BookOpen, Camera, Music } from 'lucide-react';

const AddSpouseForm = ({ onSubmit, onCancel }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const spouseData = {
      ...
      stories: formData.storyTitle || formData.audioFile ? {
    ...
    <form onSubmit={handleSubmit} className="premium-form">
      ...
      <div className="section-card">
        <div className="section-header">
          ...
          <h3 className="section-title">Marriage Information</h3>
        </div>
