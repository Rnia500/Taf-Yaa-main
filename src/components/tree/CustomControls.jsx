...
import { ZoomIn, ZoomOut, Maximize, Home, Rotate3d  } from 'lucide-react';
...
function CustomControls({ handleResetView, handleToggleOrientation  }) {
  ...
  return (
    <div className="controls-container">
      ...
      <ControlButton onClick={handleToggleOrientation} title="Toggle Orientation"><Rotate3d  color="var(--color-primary2)" size={20} /></ControlButton>
